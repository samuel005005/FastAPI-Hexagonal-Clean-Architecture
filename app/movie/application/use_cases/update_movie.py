...
class UpdateMovieParam:
    def __init__(self, id_movie: int, movie: Movie):
        self.id_movie = id_movie
        self.movie = movie


class UpdateMovie(UseCaseArgument[UpdateMovieParam, Movie]):
    def __init__(self, repository: MovieRepository):
        self.repository = repository

    def execute(self, update: UpdateMovieParam) -> Movie:
        return self.repository.update(id_movie=update.id_movie, movie=update.movie)
